...
#include "nrLDPC_extern.h"
//#include "types.h"
#include "nr_unitary_defs.h"
#include "rangen_double.c"
//#include "time_meas.h"

#include "ldpc_encoder_optim8segmulti_test.c"
#include "ldpc_encoder_testnew.c"
#include "nrLDPC_decoder.c"
...
int main(int argc, char *argv[])
{
  ...
  double errors_bit_uncoded;
  short block_length=8448; //8448; // decoder supports length: 1201 -> 1280, 2401 -> 2560
