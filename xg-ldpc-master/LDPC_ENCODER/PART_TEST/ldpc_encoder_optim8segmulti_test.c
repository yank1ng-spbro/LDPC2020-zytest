...
#include "ldpc_encode_parity_check_test.c"
#include "ldpc_generate_coefficient_test.c"



int nrLDPC_encoder(unsigned char **test_input,unsigned char **channel_input,int Zc,int Kb,short block_length, short BG, encoder_implemparams_t *impp)
{
...
*/
  ...
  printf("no valid Zc found for block length %d\n",block_length);
